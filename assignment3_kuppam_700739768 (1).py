...
"""By seeing the above results, with Naive Bayes accuracy with 25.52 % and SVM has accuracy of 62.79. On comparing the on two models, SVM is performing better than the Naive Bayes.

Naive Bayes is a classifier and will therefore perform better with categorical data
"""